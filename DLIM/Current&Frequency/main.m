...
parfor x=min_freq:max_freq
  for y=min_amp:max_amp
    simulationNumber=y+(x-1)*max_amp;
    tic

    freq = x;
    inputCurrent = y;

    disp(append("Starting simulation number ",num2str(simulationNumber)," with parameters inputCurrent=",num2str(inputCurrent),", frequency=",num2str(freq)))
    ...
    disp(append("Simulation number ",num2str(simulationNumber)," completed in ",num2str(singleSimTimeElapsed)," seconds with parameters inputCurrent=",num2str(inputCurrent),", frequency=",num2str(freq)))
