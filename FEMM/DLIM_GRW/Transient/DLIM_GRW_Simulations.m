...
mi_setblockprop(Air,1,0,'<None>',0,0,0);
mi_makeABC;
mi_saveas(append('..\qnafiles\temp_',num2str(angle),'.fem'));
mi_analyze;
mi_loadsolution;
...
mo_savebitmap(append('temp_images\DLIM_GRW_angle_',sprintf('%03d',angle),'.jpg'))
